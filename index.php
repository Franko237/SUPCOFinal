	...
	<body>
		<div class = "container-fluid ">
			<!--header-->
				...
				<header class="header">
						<div id="titre_principal">
							...
							<div class="topbar">
									<nav>
										...
										<?php if(!isset($_SESSION["user"])){ ?>
											...
											<?php if(!isset($_SESSION["user"])){ ?>
											<li><a href="#" >SUP DE CO</a></li>
											<?php }else{ ?>
												<li><a href="mot.html" >SUP DE CO</a></li>
											<?php } ?>
											<?php if(!isset($_SESSION["user"])){ ?>
											<li class="menu-html"><a href="#">NOS PROGRAMMES</a>
												<ul class="submenu">
													<li><a href="#">CYCLE BTS</a></li>
													<li><a href="#">CYCLE PROFESSIONNEL</a></li>
													<li><a href="#">Programme Grande école</a></li>
													<li><a href="#">ENGLISH BACHELOR</a></li>
													<li><a href="#">CYCLE DBA</a></li>
													<li><a href="#">Liste etudiant BTS</a></li>
												</ul>
											</li>
											<?php }else{ ?>
										...
										<ul>
											<?php if(!isset($_SESSION["user"])){ ?>
											<li><a href="users_inscription.php"  >INSCRIPTION</a></li>
						 ...
						 <h5>Pour pouvoir naviguer bien vouloir se connecter ou s'incrire s'il vous plait !!!!</h5>
			</header>
			<!--End header-->
			<!--Bannière-->
			...
			<div class="inner-banner">
					  ...
					  <?php if(!isset($_SESSION["user"])){ ?>
					  <a class="btn btn-custom" href="#">CONTACTER NOUS!</a>
					  <?php }else{ ?>
					...
					<div class="col-lg-12">
						<h2 id="cycle">NOS PROGRAMMES</h2>
							<div class="row span">
							   ...
							   <?php if(!isset($_SESSION["user"])){ ?>
								<a class="btn btn-custom" href="">	<img src="img/bts.jpg" alt="BTS" id="bt"/></a>
								<?php }else{ ?>
								...
								<?php if(!isset($_SESSION["user"])){ ?>
									<a class="btn btn-custom" href="">	<img src="img/lipro2.jpg" alt="LIPRO" id="lip"/></a>
								<?php }else{ ?>
								...
								<?php if(!isset($_SESSION["user"])){ ?>
									<a class="btn btn-custom" href=""><img src="img/mba.jpg" alt="MBA" id="mb"/></a>
								<?php }else{ ?>
							...
							<div class="row span">
							   ...
							   <?php if(!isset($_SESSION["user"])){ ?>
								<a class="btn btn-custom" href="">	<img src="img/bapf.jpg" alt="BTS" id="bapf"/></a>
								<?php }else{ ?>
								...
								<?php if(!isset($_SESSION["user"])){ ?>
									<a class="btn btn-custom" href="">	<img src="img/dbapf.jpg" alt="LIPRO" id="dbapf"/></a>
								<?php }else{ ?>
